Feature: Le Juste bar
    ...
    Scenario: Third story   
        ...
        And they each order a cocktail of the month costing 10 dollars
        And each pays their own drink
        When they finish their cocktail, each person check they receipt
        And Mr Pignon pays but Mr Leblanc insists to order one more drink of the month
